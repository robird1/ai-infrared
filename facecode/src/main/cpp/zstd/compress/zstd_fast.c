...
size_t ZSTD_compressBlock_fast_generic(
    ...
    const U32 prefixStartIndex = (endIndex - validStartIndex > maxDistance) ? endIndex - maxDistance
                                                                            : validStartIndex;
    ...
    while (ip < ilimit) {   /* < instead of <=, because repcode check at (ip+1) */
        ...
        if (((U32) ((prefixStartIndex - 1) - repIndex) >=
            ...
            if (dictMatchIndex <= dictStartIndex ||
                ...
                mLength =
                        ZSTD_count_2segments(ip + 4, dictMatch + 4, iend, dictEnd, prefixStart) + 4;
...
size_t ZSTD_compressBlock_fast_dictMatchState(
    ...
    switch (mls) {
        default: /* includes case 3 */
        case 4 :
            return ZSTD_compressBlock_fast_dictMatchState_generic(ms, seqStore, rep, src, srcSize,
                                                                  4);
        case 5 :
            return ZSTD_compressBlock_fast_dictMatchState_generic(ms, seqStore, rep, src, srcSize,
                                                                  5);
