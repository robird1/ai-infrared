...
ZBUFF_compressInitDictionary(ZBUFF_CCtx *cctx, const void *dict, size_t dictSize,
                             int compressionLevel);

ZBUFF_DEPRECATED("use ZSTD_compressStream") size_t
ZBUFF_compressContinue(ZBUFF_CCtx *cctx, void *dst, size_t *dstCapacityPtr, const void *src,
                       size_t *srcSizePtr);
...
ZBUFF_decompressInitDictionary(ZBUFF_DCtx *dctx, const void *dict, size_t dictSize);
