...
import com.uls.multifacetrackerlib.BuildConfig;
...
public class L {
    ...
    private static String TAG = "ULSee";//默认tag
    ...
    private static void performPrint(int level, String tag, String msg) {
        ...
        //不是debug mode只会打印Error信息
        if ( !ULSeeTrackerManager.debugMode && level != Log.ERROR) {
            return;
        }
