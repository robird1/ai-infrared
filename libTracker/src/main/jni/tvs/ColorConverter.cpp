...
void ColorConverter::initialise(const cv::Size targetSize, const int rotation) {
...
void ColorConverter::startConverting(const GLint srcTexture) {
...
void ColorConverter::finishConversion() {
  _fbo.unbind();
...
const cv::Mat& ColorConverter::getResult() {
...
void ColorConverter::releaseResult() {
