...
Mat getPyramidStitchingImage2(Mat &input_image,
    ...
    if (stitch_x) {
        ...
        do {
            ...
            location_and_scale.push_back(
                    make_pair(Rect(min_start, height_index[min_start].second, current_size.width,
                                   current_size.height),
            ...
            height_index[min_start + current_size.width + interval].first -=
                    current_size.width + interval;
        ...
        do {
            ...
            location_and_scale.push_back(
                    make_pair(Rect(width_index[min_start].second, min_start, current_size.width,
                                   current_size.height),
            ...
            width_index[min_start + current_size.height + interval].first -=
                    current_size.height + interval;
