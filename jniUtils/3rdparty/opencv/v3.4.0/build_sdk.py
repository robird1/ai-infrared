...
ABIs = [
    ...
    ABI("2", "armeabi-v7a", "", cmake_name="armeabi-v7a with NEON"),
    ABI("3", "arm64-v8a",   ""),
]
...
class Builder:
    ...
    def get_toolchain_file(self):
        ...
        return os.path.join(self.ndkdir, "build", "cmake", "android.toolchain.cmake")
...
if __name__ == "__main__":
    ...
    builder = Builder(args.work_dir, args.opencv_dir, args.ndk_path)
