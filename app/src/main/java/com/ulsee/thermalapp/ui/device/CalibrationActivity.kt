...
//            Log.i(Tag, "onScale = "+(detector.scaleFactor) +", new factor="+mScaleFactor)
    ...
    private fun alignImage () {
        ...
        Log.d("CalibrationActivity", "mTwoPictureInfo!!.XCali: ${mTwoPictureInfo!!.XCali} mTwoPictureInfo!!.YCali: ${mTwoPictureInfo!!.YCali} mTwoPictureInfo!!.WCali: ${mTwoPictureInfo!!.WCali} mTwoPictureInfo!!.HCali: ${mTwoPictureInfo!!.HCali}")
        Log.d("CalibrationActivity", "thermalIV.x: ${thermalIV.x} thermalIV.y: ${thermalIV.y} layoutParams.width: ${layoutParams.width} layoutParams.height: ${layoutParams.height}")
//        val initScale = 0.5
