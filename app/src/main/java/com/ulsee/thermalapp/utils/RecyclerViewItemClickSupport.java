...
public class RecyclerViewItemClickSupport {
    ...
    private RecyclerViewItemClickSupport(RecyclerView recyclerView) {
        ...
        mRecyclerView.setTag(RecyclerViewItemClickSupport.tag, this);
        mRecyclerView.addOnChildAttachStateChangeListener(mAttachListener);
    }

    public static RecyclerViewItemClickSupport addTo(RecyclerView view) {
        RecyclerViewItemClickSupport support = (RecyclerViewItemClickSupport) view.getTag(RecyclerViewItemClickSupport.tag);
        if (support == null) {
    ...
    private void detach(RecyclerView view) {
        ...
        view.setTag(RecyclerViewItemClickSupport.tag, null);
    }
}